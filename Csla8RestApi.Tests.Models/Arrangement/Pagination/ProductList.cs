...
{
    /// <summary>
    /// Represents a read-only paginated product collection.
    /// </summary>
    [Serializable]
    public class ProductList : ReadOnlyModel<ProductList>
    {
        ...
        /// <summary>
        /// Gets the specified read-only paginated product collection.
        /// </summary>
        /// <param name="factory">The data portal factory.</param>
        /// <param name="criteria">The criteria of the read-only product list.</param>
