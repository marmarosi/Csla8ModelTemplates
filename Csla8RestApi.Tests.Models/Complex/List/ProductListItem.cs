...
namespace Csla8RestApi.Tests.Models.Complex.List
{
    ...
    public class ProductListItem : ReadOnlyModel<ProductListItem>
    {
        ...
        public static readonly PropertyInfo<ProductListParts> PartsProperty = RegisterProperty<ProductListParts>(nameof(Parts));
        public ProductListParts Parts
        {
            get => ReadProperty(PartsProperty);
        ...
        private async Task FetchAsync(
            ...
            [Inject] IChildDataPortal<ProductListParts> itemPortal
            )
        {
            // Load values from persistent storage.
            DataMapper.Map(dao, this, "Parts");
            Parts = await itemPortal.FetchChildAsync(dao.Parts);
        }
