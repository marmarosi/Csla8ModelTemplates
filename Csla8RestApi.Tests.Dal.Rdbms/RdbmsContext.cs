...
namespace Csla8RestApi.Tests.Dal.Rdbms
{
    /// <summary>
    /// Represents a session with the database.
    /// </summary>
    public class RdbmsContext : DbContext, ITransactionOptions
    {
        #region Constructors
        ...
        public RdbmsContext(
            DbContextOptions<RdbmsContext> options,
            ...
            )
        {
            ...
            modelBuilder.Entity<Part>()
                .HasIndex(e => new { e.ProductKey, e.PartKey })
                .IsUnique();
